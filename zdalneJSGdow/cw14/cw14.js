document.addEventListener("DOMContentLoaded", function () {
    let id = "";
    document.querySelector("#rectangle2").innerHTML = `<span class='zegarek'>${new Date().toLocaleTimeString()}</span>`
    ...
    id = setInterval(function () {
        ...
        document.querySelector("#rectangle2").innerHTML = `<span class='zegarek'>${time.toLocaleTimeString()}</span>`
    }, 1000);
